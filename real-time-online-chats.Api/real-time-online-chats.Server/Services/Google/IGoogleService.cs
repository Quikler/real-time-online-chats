...
{
    Task<Result<AuthSuccess, AuthFailure>> LoginAsync(GoogleJsonWebSignature.Payload payload);
    Task<Result<AuthSuccess, AuthFailure>> SignupAsync(GoogleJsonWebSignature.Payload payload);
