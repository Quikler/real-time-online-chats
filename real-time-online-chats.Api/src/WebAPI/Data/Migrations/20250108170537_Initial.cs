    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatEntityUserEntity", x => new { x.MemberChatsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_ChatEntityUserEntity_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatEntityUserEntity_Chats_MemberChatsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatEntityUserEntity_MembersId",
