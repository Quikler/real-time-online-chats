          ...
          <div className="mx-auto max-w-screen-sm text-center relative">
            <div className="absolute -top-16 left-1/2 -translate-x-1/2 opacity-20 dark:opacity-10">
              <svg viewBox="0 0 200 200" className="w-64 h-64" xmlns="http://www.w3.org/2000/svg">
                <path fill="currentColor" d="M45.8,-76.4C58.9,-70.4,68.7,-58.1,75.8,-44.3C82.9,-30.5,87.4,-15.3,87.9,0.2C88.4,15.6,84.9,31.3,77.1,44.6C69.3,57.9,57.2,68.9,43.3,75.8C29.4,82.7,13.7,85.5,-0.7,86.7C-15.1,87.9,-30.2,87.5,-43.8,81.1C-57.3,74.7,-69.3,62.3,-76.1,47.9C-82.9,33.5,-84.5,17.3,-83.9,1.1C-83.3,-15.2,-80.5,-30.3,-72.8,-42.8C-65.1,-55.2,-52.5,-64.9,-38.7,-70.4C-24.9,-75.8,-9.9,-77,3.7,-82.8C17.3,-88.6,34.6,-99,45.8,-76.4Z" transform="translate(100 100)"/>
              </svg>
            </div>
